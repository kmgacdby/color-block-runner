...
public final class ColorBlock {
    ...
    public static DyeColor getDyeColor(Block block) {
        ...
        // Treat Minecraft's uncolored/base variants as the white/base color.
        // There is no uncolored concrete block in vanilla Minecraft; concrete is
        // always one of the 16 dyed variants.
